...
public class ListCollectionsDemo1 {

    public static void main(String[] args) {
        // initalise the list
        ArrayList<String> obj1 = new ArrayList<>();// type safe - no exception
        obj1.add("sample1");
        obj1.add("sample2");
        obj1.add("sample3");

        List obj2 = new ArrayList<>(); // this might result in runtime exception
        obj2.add("sample4");
        obj2.add("sample5");
        obj2.add("sample6");
